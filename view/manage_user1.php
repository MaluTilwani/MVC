...
<div class="table-container">
    <form id="userFilterForm" class="filter-form" style="gap: 10px;">
    ...
    <button type="button" id="clearUserFilter" class="btn btn-secondary">Clear</button>
</form>
    <h2>Manage Users</h2>
    <table>
        <tr>
...
$(document).ready(function () {
    $('#userFilterForm').on('submit', function (e) {
        ...
        $.ajax({
            ...
            error: function () {
                alert('Error loading filtered users.');
            }
        });
    });
